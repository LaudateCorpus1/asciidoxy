...
from .description_parser_v2 import (parse_description, select_descriptions, NamedSection,
...
def _to_asciidoc_or_empty(description: Optional[NestedDescriptionElement]) -> str:
    if description is not None:
        ...
        return ParaContainer(*description.contents).to_asciidoc()
    return ""
...
class ParserBase(ABC):
    ...
    def parse_enumvalue(self, enumvalue_element: ET.Element, parent_name: str) -> Compound:
        ...
        enumvalue.brief, enumvalue.description = select_descriptions(
            parse_description(enumvalue_element.find("briefdescription")),
            parse_description(enumvalue_element.find("detaileddescription")))
    ...
    def parse_member(self, memberdef_element: ET.Element, parent: Compound) -> Optional[Compound]:
        ...
        brief = parse_description(memberdef_element.find("briefdescription"))
        detailed = parse_description(memberdef_element.find("detaileddescription"))
    ...
    def parse_compounddef(self, compounddef_element: ET.Element) -> None:
        ...
        compound.brief, compound.description = select_descriptions(
            parse_description(compounddef_element.find("briefdescription")),
            parse_description(compounddef_element.find("detaileddescription")))
